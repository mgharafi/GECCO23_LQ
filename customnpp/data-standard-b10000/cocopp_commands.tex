...
\providecommand{\algBtables}{\StrLeft{LQ}{\ntables}}
\providecommand{\algAtables}{\StrLeft{Como}{\ntables}}
\providecommand{\ntables}{4}
\providecommand{\pptablesfooter}{
\end{tabularx}
}
...
\providecommand{\algsfolder}{Como_LQ_COMO-/}
\providecommand{\algorithmA}{COMO-10 dufosse bbob-biobj}
\providecommand{\algorithmB}{Como}
\providecommand{\algorithmC}{LQ}
