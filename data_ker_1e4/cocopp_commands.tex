...
\providecommand{\cocoversion}{{\scriptsize\sffamily{}\color{Gray}Data produced with COCO v2.6, hv-hashes inconsistent: 39fb5e94297ca5cb and ff0e71e8cd978373 found!}}
\providecommand{\numofalgs}{2}
...
Expected running time (\ERT\ in $\log_{10}$ of number of function evaluations)
        ...
        $\DI \in [3\times10^{21}, 10^{-05}]$ in each dimension on functions #1. Markers on the upper or right edge indicate that the respective target
...
\providecommand{\algBtables}{\StrLeft{kerComo}{\ntables}}
...
%
        ...
        %
        to reach a target value $\hvref+\DI$ with $\DI=10^{k}$, where
...
\providecommand{\algsfolder}{kerLQ_kerCo/}
\providecommand{\algorithmA}{kerComo}
\providecommand{\algorithmB}{kerLQ}
